...
import { GiTeacher } from "react-icons/gi";
import { GiRank3 } from "react-icons/gi";
>>>>>>> 315dec6b6c0ea48db07e2894844268bef1a39fa6
import styles from "@/styles/program.module.css";

const Programs = () => {
  return (
    <div className=" py-14 mt-4 bg-gray-200 mx-3">
      ...
      <div className="  flex justify-center">
        <p className=" mt-4 p-3 text-center max-w-[700px]">
          The main purpose of the us , Is to provide an environment In which
          faculty and students Can discover and transmit The knowledge, wisdom,
          and values.{" "}
        </p>
      </div>
          ...
          <div className="grid lg:grid-cols-3 md:grid-cols-1 sm:grid-cols-1 gap-5 ">
            <div className=" lg:col-span-2 pb-10">
              <div className=" grid lg:grid-cols-2 md:grid-cols-2 max-w-[680px] gap-3  h-60 shadow-2xl p-3 rounded-lg bg-white ">
                ...
                <div className=" flex justify-center p-6  ml-2 lg:visible  md:visible invisible">
                  <Image src={chose} alt="" className=" w-44" />
                </div>
              </div>
>>>>>>> 315dec6b6c0ea48db07e2894844268bef1a39fa6
            </div>
