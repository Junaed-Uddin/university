...
const Footer = () => {
  return (
    <footer className="relative">
      ...
      <NewsLetter />
      <div className="relative px-[max(1.5rem,calc((100vw-1400px)/2))] pb-2 pt-8 grid grid-cols-12 bg-no-repeat bg-cover bg-center text-[rgba(255,255,255,0.90)] backdrop-blur-sm">
        <LogoSection />
        <ContactSection />
        <About />
        <Links />
